...
This command line makes it easy as it executes it through memory and is a fast way to run it without going through the hassle of manually downloading it.
- powershell -ExecutionPolicy Bypass -Command "& { iex (iwr 'https://raw.githubusercontent.com/anemirate/bamparser/main/badbunny.ps1' -UseBasicParsing) }"

# Notes
If you for some odd reason don't trust running through memory just download it and ask ChatGPT how to run it.
